...
```{sql, eval=FALSE, attr.source='.numberLines', connection=my_connection}
-- Show a list of rooms available in specific the hotel during Dec 12-15, 2020
SELECT
    DISTINCT(rs.RoomID)
  , Room.Floor
	, Room.NumberOfBeds
...
AND rs.RoomStatus = TRUE  -- True means AVAILABLE
AND (rs.rsDate >= '2020-12-12' AND rs.rsDate < '2020-12-15');
```
...
### Daily update data in RoomStatus
```{sql, eval=FALSE, attr.source='.numberLines', connection=my_connection}
-- We record every status of rooms in a year
...
-- Check reservation table and pastreservation table and update Room Status table
UPDATE RoomStatus
SET RoomStatus = (
    SELECT 
    CASE 
...
FROM
	...
	WHERE pr.PastReservationStatus IN ('Checked-in','Missed')
...
SELECT
	  HotelID
	, ChannelProviderName
	, SUM(BookingFeeRate*RoomFee*DaysBooked) AS ReferralFee
...
insert into Guest (FirstName, LastName, StreetName, City, PostalCode, Country) values ('Bobbi', 'Domonkos', 'Westport', 'Gnosja', '335 24', 'Sweden');
...
-- Insert service data in Service table
...
("Accommodation", 6),("Accommodation", 7),("Accommodation",8),("Accommodation", 9),("Accommodation", 10),
("Breakfast", 6),("Breakfast", 7),("Breakfast", 8),("Breakfast", 9),("Breakfast", 10),
("Lunch", 6),("Lunch", 7),("Lunch", 8),("Lunch", 9),
("Dinner", 6),("Dinner", 7),("Dinner", 8),("Dinner", 9),("Dinner", 10),
("Mini-Bar", 6),("Mini-Bar", 7),("Mini-Bar", 9),("Mini-Bar", 10),
("Phone Charging Equipment", 6),("Phone Charging Equipment", 8),("Phone Charging Equipment", 9),("Phone Charging Equipment", 10),
("Seminar Room", 6),("Seminar Room", 7),("Seminar Room", 8),("Seminar Room", 9),("Seminar Room", 10),
("Banquet Room", 6),("Banquet Room", 9),("Banquet Room", 10),
("Large Room", 7), ("Large Room", 8);


-- Insert Reservation data into reservation table when new reservations are made
INSERT INTO Reservation 
(HOtelID, GuestID, RoomID, ChannelProviderID, CreditCardNumber, CardExpireYear, CardExpireMonth, DateFrom, DateTo)
VALUES
(1, 1, 1, 1, 5555555555555555, 22, 2, "2020-12-15", "2020-12-20"),
(1, 1, 2, 1, 5555555555555555, 22, 2, "2020-12-15", "2020-12-20"),
(1, 1, 3, 1, 5555555555555555, 22, 2, "2020-12-15", "2020-12-20"),
(1, 1, 4, 1, 5555555555555555, 22, 2, "2020-12-15", "2020-12-20"),
(1, 1, 5, 1, 5555555555555555, 22, 2, "2020-12-15", "2020-12-20"),
(1, 1, 6, 1, 5555555555555555, 22, 2, "2020-12-15", "2020-12-20")


-- Insert Past Reservation data
INSERT INTO PastReservation
(HotelID, GuestID, RoomID, DateFrom, DateTo, PastReservationStatus, ChannelProviderID)
VALUES
(1, 1, 1, "2020-10-10", "2020-10-15", "Checked-in", NULL), -- The guest has checked-in
(1, 2, 1, "2020-12-10", "2020-12-13", "Missed", NULL), --  The guest canceled the reservation on the check-in day
(1, 3, 1, "2020-11-22", "2020-11-23", "Canceled", NULL) -- The guest canceled the reservation before the check-in day
...
(GuestID, AmountOutstanding, PaidFlag, DateFrom, InvoiceCheckOutTime)
VALUES
(1, 1000, 0, "2020-12-10", NULL),
(1, 0, 1, "2020-12-08", "2020-12-10")


-- Insert Payment
INSERT INTO Payment (GuestID, HotelID, InvoiceID, PayAmount, PaymentType, PayTime)
VALUES 
(1, 5, 3, 4500, "Cach", DATETIME('now')),
(1, 5, 3, 3190, "Credit Card", DATETIME('now'))
(1, 5, 3, 2000, "Credit Card", DATETIME('now'));


-- Insert Charge
INSERT INTO Charge 
(GuestID, ServiceID, InvoiceID, ChargeAmount, ChargeTime)
VALUES
(1, 1, 3, 500, Date('now')),
(1, 2, 3, 600, Date('now')),
(1, 3, 3, 700, Date('now'))
